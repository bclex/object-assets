...
namespace OA.XR.Editor
{
    ...
    {
        static bool AllowOverride { get; set; }
        ...
        private static void BindAxisAndButtons()
        {
            ...
            catch { Utils.Error("Failed to apply VR Input manager bindings"); }
        }

        [MenuItem("ObjectManager/VR/Reset Input Binding", false, 100000)]
        ...
        private static void BindRawAxis(Axis axis)
        {
            ...
            var axesProperty = serializedObject.FindProperty("_axes");
            ...
            while (axisIter.Next(false))
                if (axisIter.FindPropertyRelative("_name").stringValue == axis.name && !AllowOverride)
                    return;
            ...
            axisProperty.FindPropertyRelative("_name").stringValue = axis.name;
