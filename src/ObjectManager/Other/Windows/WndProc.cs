...
namespace OA.Core.Windows
{
    ...
    public class WndProc : MessageHook
    {
        ...
        {
            var message = new Message(msg, wParam, lParam);
        ...
        private void WmKeyEvent(ref Message message)
        {
            ...
            if ((message.Id == NativeConstants.WM_CHAR) || (message.Id == NativeConstants.WM_SYSCHAR))
            {
                ...
                var e = new InputEventKeyboard(KeyboardEvent.Press,
            ...
            else
            {
                ...
                {
                    var e = new InputEventKeyboard(KeyboardEvent.Down,
                        (WinKeys)(int)(long)message.WParam,
                        (int)(long)message.LParam,
                        ModifierKeys
                        );
                ...
                {
                    var e = new InputEventKeyboard(KeyboardEvent.Up,
                        (WinKeys)(int)(long)message.WParam,
                        (int)(long)message.LParam,
                        ModifierKeys
                        );
