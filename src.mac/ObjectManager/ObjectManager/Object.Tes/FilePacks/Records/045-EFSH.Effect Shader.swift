...
public class EFSHRecord: Record {
    public struct DATAField {
        ...
        init(_ r: BinaryReader, _ dataSize: Int) {
            ...
            fillTextureEffect_color = r.readT(dataSize)
            ...
            edgeEffect_color = r.readT(dataSize)
            ...
            colorKey1_color = r.readT(dataSize)
            colorKey2_color = r.readT(dataSize)
            colorKey3_color = r.readT(dataSize)
